...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html">EmployMe</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 ftco-animate">
          ...
          <form action="apply_job.php" method="POST" id="employme" enctype="multipart/form-data" style="border: 1px solid gray;">
            <div style="padding: 2%;">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="file" name="file" id_file class="form-control">
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
